...
/*if(isset($_POST['id_cours'])){
  $_SESSION['IDRepas'] = $_POST['id_repas'];
  header("location:http://localhost/hiit/DetailsRepas.php");
...
try{
	...
	$sql = "SELECT * FROM repas WHERE `IdUtilisateur` = $IdUtilisateur";
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo "IDRegime : $IDRegime";?></p>    
  </div>
</div>
